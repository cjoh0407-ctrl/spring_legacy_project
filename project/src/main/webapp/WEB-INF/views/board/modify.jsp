...
<style>
    ...
    .container { width: 800px; margin: 40px auto; background: #fff; padding: 40px; border-radius: 12px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); }
    
    h2 { margin-bottom: 30px; color: #333; font-size: 24px; text-align: center; }
    ...
    .btn-area { display: flex; justify-content: center; gap: 15px; margin-top: 30px; border-top: 1px solid #eee; padding-top: 20px; }
    .btn { padding: 12px 30px; border-radius: 6px; cursor: pointer; font-size: 15px; font-weight: 600; text-decoration: none; border: none; transition: 0.2s; }
